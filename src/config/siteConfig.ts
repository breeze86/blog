...
export const siteConfig: SiteConfig = {
	// 站点标题
	title: "晓峰 - 记录技术 • 分享思考 • 探索无限",

	// 站点副标题
	subtitle: "工程师的实验笔记，偶尔也写生活切片",

	// 站点 URL
	site_url: "https://blog.feng186.cn",

	// 站点描述
	description:
		"这里是晓峰的个人博客。写代码踩的坑、折腾工具到半夜的烦躁、AI 带来的新可能，也会写生活里的碎片和想法。不追求更新频率，写给自己为主。如果某篇碰巧对你有用，那很好。",
